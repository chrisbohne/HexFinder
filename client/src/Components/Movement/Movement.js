  ...
  return (
    <div className="movement">
      ...
      <div className="horizontal-container">
        <svg onClick={()=> moveGrid('horizontal', -100)} className="playground-icon move-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg onClick={()=> moveGrid('horizontal', 100)} className="playground-icon move-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
